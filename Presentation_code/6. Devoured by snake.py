...
class Player():
    ...
    def devoured_by_snake(self):
        snake_stage_84 = (310, 100)
        animation_snake_stage_84 = { (310, 100) : (500, 150), (500, 150) : (350, 200), (350, 200) : (210, 260) }
        
        for i in range( len(animation_snake_stage_84.keys()) ):
            self.player_x, self.player_y = animation_snake_stage_84[(self.player_x, self.player_y)]
...
player1 = Player( "Player1", storage_of_file_player, 310 , 100 )
